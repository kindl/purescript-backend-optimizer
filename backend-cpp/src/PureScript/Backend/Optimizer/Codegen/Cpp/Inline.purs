module PureScript.Backend.Optimizer.Codegen.Cpp.Inline where
...
import Dodo as Dodo
import PureScript.Backend.Optimizer.Codegen.Cpp.Common (CppStatement(..), esUpdateLeft, esUpdateRight)
...
type EsInlineCall a = (TcoExpr -> Dodo.Doc a) -> Qualified Ident -> Array TcoExpr -> Maybe (Tuple (Dodo.Doc a) (CppStatement (Dodo.Doc a)))
